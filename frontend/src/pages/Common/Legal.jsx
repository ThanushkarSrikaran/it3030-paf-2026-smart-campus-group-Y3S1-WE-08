    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <PageHeader 
                ...
                description="Regulatory framework, terms of service, and data privacy policies governing the use of the Smart Campus Operations platform."
            />
                    ...
                    <div className="max-w-3xl space-y-10">
                        <section>
                            ...
                            <div className="space-y-4 text-slate-500 text-sm leading-relaxed">
                                <p>
                                    By accessing the Smart Campus Operations Center, you agree to comply with the university's Acceptable Use Policy and all local regulations regarding infrastructure management.
                                </p>
                                <p>
                        ...
                        <section>
                            ...
                            <div className="space-y-4 text-slate-500 text-sm leading-relaxed">
                                <p>
                                    Smart Campus employs industry-standard AES-256 encryption for all data at rest and TLS 1.3 for data in transit. We prioritize the security of campus personnel data and operational logs.
                                </p>
                                <p>
