    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <PageHeader 
                ...
                description="Get in touch with the Smart Campus Operations Center for facility assistance, technical support, or emergency maintenance requests."
            />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
                <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm hover:shadow-lg transition-all">
                    ...
                    <a href="mailto:support@smartcampus.edu" className="text-blue-600 font-bold hover:underline">
