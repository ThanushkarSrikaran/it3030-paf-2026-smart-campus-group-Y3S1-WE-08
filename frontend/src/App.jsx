    ...
    return (
        <div className="p-6 md:p-8 bg-gradient-to-b from-slate-50 to-white min-h-[calc(100vh-10rem)]">
            <PageHeader 
                ...
                description="Welcome to the Smart Campus Operations Center. Monitor campus infrastructure, manage bookings, and handle incident resolutions from this unified dashboard."
            />
